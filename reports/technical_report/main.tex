...
(feature schema, frozen models, conformal policy, package, workchain hardening) that L2/L3 reuse. \textbf{L3
(warm start) is now realized as PotentialBank~v1} (Sec.~\ref{sec:potbank}): a certified catalog of
single-structure converged potentials with measured same-structure warm-start savings.
...
warm-start outputs are benchmarks and are \emph{not} themselves certified as donors.
